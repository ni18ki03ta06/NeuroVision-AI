...
export default function ResultsPage() {
      ...
      <SkeletonTheme baseColor="#161b22" highlightColor="#21262d">
        <div className="flex flex-col gap-10 text-slate-200">
          <div>
            ...
            <Skeleton width={320} height={14} style={{ marginTop: '8px' }} />
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="bg-slate-900/40 border border-slate-800/80 p-5 rounded-xl flex flex-col gap-3">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-7 bg-slate-900/40 border border-slate-800/80 p-6 rounded-2xl h-64">
              <Skeleton width={150} height={16} />
              <Skeleton count={4} height={30} style={{ marginTop: '16px' }} />
            </div>
            <div className="lg:col-span-5 bg-slate-900/40 border border-slate-800/80 p-6 rounded-2xl h-64">
  ...
  return (
    <div className="flex flex-col gap-10 text-slate-200">
      ...
      <ScrollReveal>
        <div className="bg-slate-900/40 border border-slate-850/80 p-6 rounded-2xl shadow-md flex flex-col gap-4">
          <div>
